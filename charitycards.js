...
d3.csv("data/charities_list_clean.csv", function(dataset) {
  ...
  for (i = 0; i < newdata.length; i++) {
    ...
    var last_updated = document.createTextNode(" | Active as of "+newdata[i]["info_last_updated"]);
    var incpt_date = document.createTextNode("Founded "+newdata[i]["Inception_Date"]+" ago");
